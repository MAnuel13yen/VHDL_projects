...
-- Design Ports Information
-- clock_1s	=>  Location: PIN_N26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clock50mhz	=>  Location: PIN_W15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- reset	=>  Location: PIN_V15,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF clock1s IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \clock_1s~output_o\ : std_logic;
...
SIGNAL \counter_registro~0_combout\ : std_logic;
SIGNAL \counter_registro~q\ : std_logic;
...
\clock_1s~output\ : cycloneiv_io_obuf
...
-- pragma translate_on
PORT MAP (
	i => \counter_registro~q\,
	devoe => ww_devoe,
	o => \clock_1s~output_o\);

-- Location: IOIBUF_X57_Y0_N15
\clock50mhz~input\ : cycloneiv_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
...
\clock50mhz~inputclkctrl\ : cycloneiv_clkctrl
-- pragma translate_off
GENERIC MAP (
...
\counter~11\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~11_combout\ = (\Add0~14_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \Equal0~8_combout\ = (counter(5) & (!counter(7) & (counter(4) & counter(6))))
...
\counter~10\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~10_combout\ = (!\Equal0~10_combout\ & \Add0~24_combout\)
...
\counter~9\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~9_combout\ = (\Add0~26_combout\ & !\Equal0~10_combout\)
...
\counter~8\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~8_combout\ = (!\Equal0~10_combout\ & \Add0~28_combout\)
...
\counter~7\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~7_combout\ = (!\Equal0~10_combout\ & \Add0~30_combout\)
...
-- Equation(s):
-- \counter~5_combout\ = (\Add0~38_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~4_combout\ = (!\Equal0~10_combout\ & \Add0~40_combout\)
...
\counter~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~3_combout\ = (!\Equal0~10_combout\ & \Add0~42_combout\)
...
-- Location: LCCOMB_X93_Y53_N2
\counter~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~2_combout\ = (!\Equal0~10_combout\ & \Add0~44_combout\)
...
-- Location: LCCOMB_X93_Y53_N8
\counter~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~1_combout\ = (!\Equal0~10_combout\ & \Add0~46_combout\)
...
\counter~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter~0_combout\ = (!\Equal0~10_combout\ & \Add0~50_combout\)
...
-- Equation(s):
-- \Equal0~1_combout\ = (counter(25) & (!counter(27) & (!counter(24) & !counter(26))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (counter(20) & (counter(23) & (counter(21) & counter(22))))
...
-- Location: LCCOMB_X93_Y53_N6
\Equal0~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Equal0~0_combout\ = (!counter(28) & (!counter(30) & (!counter(29) & !counter(31))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!counter(10) & !counter(11))
...
-- Equation(s):
-- \Equal0~5_combout\ = (counter(12) & (counter(14) & (counter(15) & counter(13))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (!counter(8) & (!counter(9) & (\Equal0~6_combout\ & \Equal0~5_combout\)))
...
-- Equation(s):
-- \Equal0~9_combout\ = (counter(0) & (counter(2) & (counter(3) & counter(1))))
...
\counter_registro~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \counter_registro~0_combout\ = \counter_registro~q\ $ (\Equal0~10_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \counter_registro~q\,
	datad => \Equal0~10_combout\,
	combout => \counter_registro~0_combout\);

-- Location: FF_X93_Y53_N13
counter_registro : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clock50mhz~inputclkctrl_outclk\,
	d => \counter_registro~0_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \counter_registro~q\);

ww_clock_1s <= \clock_1s~output_o\;
END structure;
