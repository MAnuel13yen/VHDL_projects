...
-- Design Ports Information
-- clock_1s	=>  Location: PIN_AH5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Equal0~8_combout\ = (!counter(4) & (!counter(6) & (!counter(5) & !counter(7))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!counter(24) & (!counter(25) & (!counter(26) & !counter(27))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!counter(29) & (!counter(31) & (!counter(28) & !counter(30))))
